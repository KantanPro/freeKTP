	...
	class KTPWP_Plugin_Reference {
		...
		private function get_overview_content() {
			...
			<ul>
				...
				<li><strong>URL生成問題を修正</strong>：サブディレクトリに依存しない統一されたURL生成</li>
			</ul>
		...
		private function get_changelog_content() {
			...
			<div class="ktpwp-reference-section">
				...
				<div class="ktpwp-changelog-item">
					...
					<ul>
						<li><strong>URL生成問題を修正</strong>
							<ul>
								<li>サブディレクトリに依存しない統一されたURL生成</li>
								<li>統一されたURL生成クラスの実装</li>
								<li>ローカル環境と配布先環境での一貫したURL生成</li>
								<li>フォールバック機能による後方互換性の確保</li>
							</ul>
						</li>
					</ul>
				</div>
