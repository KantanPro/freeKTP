...
[ktpwp_all_tab]</code></pre>
		...
		private function get_changelog_content() {
			...
			<ul>
				<li>更新通知の改善（WordPress 6.9.1対応の強化）</li>
				<li>利益計算のバグ修正</li>
				<li>プラグイン更新チェック機能の最適化</li>
				<li>管理画面での更新情報表示の改善</li>
				<li>更新通知の安定性向上</li>
			</ul>
			...
			<h3>1.1.2(preview) - 2025年7月16日</h3>
			<ul>
				<li>利益計算の改善</li>
				<li>請求書発行警告マークの表示タイミングの改善</li>
			</ul>
			
			<h3>1.1.1(preview) - 2025年7月16日</h3>
			<ul>
				<li>利益計算の改善</li>
				<li>請求書発行警告マークの表示タイミングの改善</li>
				<li>更新通知の改善（WordPress 6.9.1対応）</li>
				...
				<li>セッション管理の最適化</li>
				<li>ファイル添付機能の強化</li>
				<li>自動マイグレーション機能の改善（データベース更新の安定化）</li>
				<li>データベース整合性チェック機能の強化（データ品質向上）</li>
				<li>消費税対応機能の包括的改善（軽減税率・税区分対応の強化）</li>
				<li>内税顧客の請求項目表示修正（表示形式の統一化）</li>
				<li>税区分ラベルの統一（「内税｜外税」表示への変更）</li>
			...
			<ul>
				...
				<li>寄付進捗管理機能の追加</li>
				<li>寄付完了後の自動メール送信機能</li>
				<li>フロントエンド通知システムの実装</li>
				<li>管理画面での寄付履歴確認機能</li>
			...
			<ul>
				...
				<li>エラーハンドリングの強化</li>
				<li>データベース構造の最適化</li>
				<li>消費税対応機能の実装（軽減税率（8%・10%）対応）</li>
				<li>税区分管理機能の追加（内税・外税の管理）</li>
				<li>一括請求書の消費税対応（顧客タブでの消費税計算）</li>
				<li>税率カラムの追加（商品・サービス・請求項目への税率設定）</li>
				<li>消費税計算ロジックの実装（内税・外税の正確な計算）</li>
				<li>税区分ラベルの統一（「内税｜外税」表示への変更）</li>
				<li>内税顧客の請求項目表示修正（表示形式の統一化）</li>
			...
			<ul>
				...
				<li>軽量化を実現し大幅なパフォーマンス向上</li>
				<li>不要なライブラリを削除（約90%のサイズ削減）</li>
				<li>安定性とパフォーマンスの大幅向上</li>
