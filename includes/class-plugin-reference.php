 ...
 * - 最新バージョン: 1.1.17(preview) - 2025年7月27日更新
		...
		private function get_changelog_content() {
			...
			<div class="ktpwp-reference-section">
				...
				<div class="ktpwp-changelog-item">
					<h4>1.1.17(preview) - 2025年7月27日</h4>
					<ul>
						<li><strong>URL生成問題１−１の修正</strong>
							<ul>
								<li>動的パーマリンク取得による環境非依存のURL生成</li>
								<li>ローカル環境と配布先環境での一貫したURL生成</li>
								<li>パーマリンク設定への対応</li>
								<li>統一されたURL生成ヘルパー関数の実装</li>
								<li>すべてのタブクラスでのURL生成ロジック統一</li>
							</ul>
						</li>
					</ul>
				</div>
