...
if ( ! defined( 'KANTANPRO_PLUGIN_VERSION' ) ) {
    define( 'KANTANPRO_PLUGIN_VERSION', '1.1.10(preview)' );
}
...
function ktpwp_is_new_installation() {
    ...
    // 1. プラグインバージョンの確認
    $plugin_version = get_option( 'ktpwp_version', '0' );
    if ( $plugin_version === '0' || empty( $plugin_version ) ) {
        return true;
    }
