...
if ( ! defined( 'KANTANPRO_PLUGIN_VERSION' ) ) {
    define( 'KANTANPRO_PLUGIN_VERSION', '1.0.7(preview)' );
}
...
function ktpwp_get_plugin_changelog() {
    ...
    <h4>1.0.7(preview) - 2025年7月</h4>
    <ul>
        <li><strong>決済設定機能の削除</strong> - ktpdoneプラグインに分離</li>
        <li><strong>プラグイン構造の最適化</strong> - セキュリティ向上</li>
        <li><strong>エラーハンドリングの改善</strong> - 安定性向上</li>
        <li><strong>パフォーマンス最適化</strong> - 処理速度向上</li>
        <li><strong>データベース構造の安定化</strong> - 信頼性向上</li>
    </ul>
    
    <h4>1.0.6(preview) - 2025年6月</h4>
    <ul>
